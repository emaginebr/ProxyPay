...
import { IconFile, IconAlert, IconActivity } from "../components/Icon";
...
export function DemoInvoice() {
  ...
  const completionUrl =
    window.location.origin + "/demo/complete?status=success&from=invoice";
  ...
  return (
    <ProxyPayProvider config={config}>
      {redirecting && <FullscreenLoading message="Criando fatura e redirecionando..." />}
      <div className="pp-wrap py-10 md:py-14 animate-fade-in-up">
        <header className="flex items-start gap-4 mb-4">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500 max-w-[62ch]">
              Teste o componente{" "}
              <code className="pp-code-inline">&lt;InvoicePayment /&gt;</code>. Uma fatura é
              criada e você é redirecionado para o checkout.
            </p>
          </div>
        </header>
        ...
        <div className="pp-alert pp-alert-info mb-6" role="status">
          <IconAlert size={18} />
          <div>
            Ao clicar em pagar, a API cria uma fatura e redireciona para o checkout. Após o
            pagamento, volta para a <strong>URL de conclusão</strong>.
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="pp-card p-6 md:p-8">
            ...
            >
              ...
              >
                Pagar {brl(total)} via {paymentMethodLabels[paymentMethod]}
              </button>
            </InvoicePayment>
          </div>
