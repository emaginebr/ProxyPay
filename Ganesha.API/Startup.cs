using Ganesha.API.Middlewares;
using Ganesha.Application;
...
using Ganesha.API.Filters;
using Ganesha.GraphQL;
...
namespace Ganesha.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.ConfigureGanesha();
            services.AddGaneshaGraphQL();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment() || env.EnvironmentName == "Docker")
            {
                ...
                app.UseSwaggerUI(c => {
                    c.SwaggerEndpoint("/swagger/v1/swagger.json", "Ganesha.API v1");
                });
            }
